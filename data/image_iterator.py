...
class ImageListIter(data.Dataset):
    ...
    def __init__(self, 
        ...
        # load image list
        self.image_list = self._get_video_list(csv_list=csv_list)
    ...
    def _get_video_list(self, csv_list):
        # formate:
        # [im_id, label, image_subpath]
        assert os.path.exists(csv_list), "Failed to locate: {}".format(csv_list)
        ...
        with open(csv_list) as f:
            ...
            logging.info("Found {} images in '{}'".format(len(lines), csv_list))
